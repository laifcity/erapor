                ...
                <div class="col-md-8">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            ...
                            <?= form_open_multipart(); ?>
                            <?= csrf_field(); ?>
                            <input type="hidden" name="id" value="<?= $dataById['id_kelas']; ?>">

                            <div class="mb-3 row">
                                <label for="nama_kelas" class="col-sm-3 col-form-label">Kelas</label>
                                <div class="col-sm-9">
                                    <select name="nama_kelas" id="nama_kelas" class="form-control">
                                        <option selected="selected" value="<?= $dataById['id_keahlian']; ?>"><?= $dataById['nama_kelas']; ?></option>
                                        <option>X</option>
                                        <option>XI</option>
                                        <option>XII</option>
                                    </select>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="kode_kelas" id="kode_kelas" class="form-control" value="<?= old('kode_kelas', $dataById['kode_kelas']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_keahlian" id="id_keahlian" class="form-control">
                                        <option selected="selected" value="<?= $dataById['id_keahlian']; ?>"><?= $dataById['komp_keahlian']; ?></option>
