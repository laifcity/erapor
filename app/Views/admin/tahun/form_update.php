                ...
                <div class="col-md-5">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            ...
                            <?= form_open_multipart(); ?>
                            <?= csrf_field(); ?>
                            <input type="hidden" name="id" value="<?= $dataById['id_tahun']; ?>">
                            <div class="form-group">
                                <label for="tahun">Tahun Pelajaran</label>
                                <input type="text" name="tahun" id="tahun" class="form-control" value="<?= old('tahun', $dataById['tahun']); ?>">
                            </div>

                            <div class="form-group">
                                <label for="">Semester</label>
                                <?php if ($dataById['smt'] == 'Ganjil') : ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="smt" id="ganjil" value="Ganjil" <?= 'checked' ?>>
                                ...
                                <?php elseif ($dataById['smt'] == 'Genap') : ?>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="smt" id="genap" value="Genap" <?= 'checked' ?>>
                                        <label class="form-check-label" for="genap">
                                            Genap
                                        </label>
                                    </div>
