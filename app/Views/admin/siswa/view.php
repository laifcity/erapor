            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="card card-success card-outline">
                        ...
                        <!-- /.card-body -->
                        <li class="list-group-item">
                            <a href="<?= base_url('admin/siswa/delete/' . $dataById['id_siswa']); ?>" class="btn btn-danger btn-sm btn-hapus"><i class="fas fa-trash"></i></a>
                            <a href="<?= base_url('admin/siswa/update_data/' . $dataById['id_siswa']); ?>" class="btn btn-warning float-right btn-sm"><i class="far fa-edit"> Edit</i></a>
                        </li>
                    </div>
                    <!-- /.card -->
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" readonly class="form-control-plaintext" id="nis" value=": <?= old('nis', $dataById['nis']); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" readonly class="form-control-plaintext" id="nisn" value=": <?= old('nisn', $dataById['nisn']); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" readonly class="form-control-plaintext" id="nama_siswa" value=": <?= old('nama_siswa', $dataById['nama_siswa']); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" readonly class="form-control-plaintext" id="alm_siswa" value=": <?= old('alm_siswa', $dataById['alm_siswa']); ?>">
                                        </div>
                                    </div>
