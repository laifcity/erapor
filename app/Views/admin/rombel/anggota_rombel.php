    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><?= $title ?> : <?= $rombel['kode_kelas'] ?></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            <table class="table table-borderless">
                                <tr>
                                    <th withd="90px">Kelas / Kompetensi Keahlian</th>
                                    <th withd="10px">:</th>
                                    <td><?= $rombel['kode_kelas'] ?> / <?= $rombel['komp_keahlian'] ?></td>
                                    ...
                                    <?php foreach ($siswa as $key) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('admin/kelas/delete_anggota_rombel/' . $key['id_siswa'] . '/' . $key['id_rombel']); ?>" class="btn btn-danger btn-sm btn-remove">
                    ...
                    <table id="example1" class="table table-bordered table-hover table-sm">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($siswa_tpk as $key) : ?>
                                <?php if ($rombel['id_keahlian'] == $key['id_keahlian']) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $key['nama_siswa']; ?></td>
                                        <td class="text-center">
                                            <a href="<?= base_url('admin/rombel/add_anggota_rombel/' . $key['id_siswa'] . '/' . $key['id_rombel']); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            <?php endforeach; ?>
