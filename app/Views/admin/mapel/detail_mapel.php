            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="<?= base_url('admin/mapelkelas') ?>"><?= $title ?></a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <th withd="30px">:</th>
                                    <td><?= $detailkelas['kode_kelas'] ?></td>
                                    <th withd="100px">Program Studi</th>
                                    <th withd="30px">:</th>
                                    <td><?= $detailkelas['komp_keahlian'] ?></td>
                                </tr>
                                <tr>
                                    <th withd="10px">Semeser</th>
                                    <th withd="30px">:</th>
                                    <td></td>
                                    <th withd="10px">Wali Kelas</th>
                                    <th withd="30px">:</th>
                                    <td></td>
                                </tr>
                            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open('admin/mapelkelas/add/' . $detailkelas['id_kelas']); ?>
                    <?= csrf_field(); ?>
