                ...
                <div class="col-md-5">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            ...
                            <?= form_open_multipart(); ?>
                            <?= csrf_field(); ?>
                            <input type="hidden" name="id" value="<?= $dataById['id_mapel']; ?>">

                            <div class="form-group">
                                <label for="k_mapel">Kode Mata Pelajaran</label>
                                <input type="text" name="k_mapel" id="k_mapel" class="form-control" value="<?= old('k_mapel', $dataById['k_mapel']); ?>">
                            </div>

                            <div class="form-group">
                                <label for="mapel">Mata Pelajaran</label>
                                <input type="text" name="mapel" id="mapel" class="form-control" value="<?= old('mapel', $dataById['mapel']); ?>">
                            </div>
