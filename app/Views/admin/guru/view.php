                    ...
                    <div class="card card-success card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="<?= base_url(); ?>/assets/foto/ptk/. $key['foto_ptk']; ?>" alt="User profile picture">
                            </div>

                            <h3 class="profile-username text-center"><?= ('nama_ptk' . $id_ptk['nama_ptk']); ?></h3>
                        ...
                        <li class="list-group-item">
                            ...
                            <a href="<?= base_url('admin/ptk/delete/' . $dataById['id_ptk']); ?>" class="btn btn-danger btn-sm btn-hapus"><i class="fas fa-trash"></i></a>
                            <a href="<?= base_url('admin/ptk/update_data/' . $dataById['id_ptk']); ?>" class="btn btn-warning float-right btn-sm"><i class="far fa-edit"> Edit</i></a>
                        </li>
                    </div>
                    <!-- /.card -->
