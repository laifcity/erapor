                ...
                <div class="col-md-8">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            ...
                            <?= form_open_multipart(); ?>
                            <?= csrf_field(); ?>
                            <input type="hidden" name="id_walikelas" value="<?= $dataById['id_walikelas']; ?>">

                            <div class="mb-3 row">
                                <label for="nama" class="col-sm-3 col-form-label">Nama PTK</label>
                                <div class="col-sm-9">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_tahun" id="id_tahun" class="form-control">
                                        <option selected="selected" value="<?= $dataById['id_tahun']; ?>"><?= $dataById['tahun']; ?></option>
