                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($jurusan as $key) : ?>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/jurusan/update_data/' . $key['id_keahlian']); ?>" class="btn btn-warning btn-sm"><i class="far fa-edit"></i></i></a>
                                                <a href="<?= base_url('admin/jurusan/delete_data/' . $key['id_keahlian']); ?>" class="btn btn-danger btn-sm "> <i class="fas fa-trash"></i></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
